...
const Missions = () => {
  return (
    <section className="my-12 w-full h-full">
      <div className="mission-wrap px-8 pb-6 text-white">
          ...
          />
            ...
            <ul className="goal-list pl-6 decoration-white mt-4">
              <li className="goal-list-item mb-[6px]">
                Access: to provide access to our members that would not
                otherwise be available. Access to education, funding, community,
                networks
              </li>
              <li className="goal-list-item mb-[6px]">
              ...
              <li className="goal-list-item mb-[6px]">
                ...
                members regardless of their differences in age, ethnicity,
                gender, gender identity or expression, language differences,
                nationality or national origin, family or marital status,
                physical, mental and development abilities, race, religion or
                belief, sexual orientation, skin color, social or economic
                class, education, work and behavioral styles, political
                affiliation, military service, caste, and other characteristics
                that make our members unique
              </li>
              <li className="goal-list-item mb-[6px]">
                {" "}
                Responsibility: as a self-governed community, we rely on members
                to be personally responsible for their actions and commitments
                to the community
              </li>
              <li className="goal-list-item mb-[6px]">
                {" "}
